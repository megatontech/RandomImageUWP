...
namespace AppStudio.Views
{
    public sealed partial class Section1DetailPage : Page
    {
        ...
        {
            this.ViewModel = new DetailViewModel<DynamicStorageDataConfig, Section1Schema>(new Section1Config());

            this.InitializeComponent();
        }

        public DetailViewModel<DynamicStorageDataConfig, Section1Schema> ViewModel { get; set; }        
